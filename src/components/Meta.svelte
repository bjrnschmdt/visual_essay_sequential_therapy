<script>
	...
	export let url = "https://www.kielscn.de";
	export let keywords = "";
...
<svelte:head>
	...
	<meta name="author" content="KielSCN" />
	<meta name="news_keywords" content="{keywords}" />

	<meta property="og:title" content="{title}" />
	<meta property="og:site_name" content="KielSCN" />
	...
	<meta name="twitter:site" content="https://www.kielscn.de" />
	<meta name="twitter:creator" content="@kielscn" />
